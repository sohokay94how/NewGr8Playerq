namespace ControlExplorer.Word
{
    ...
    partial class WordCreator : C1DemoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "复杂文档（图片，列表，表格，图形...）";
            ...
            this.label2.Text = "\"Hello World!\" 文档";
            ...
            this.label1.Text = "将文档读入一个对象模型，创建（写入）另一个文档";
            ...
            this._check2007.Text = "保持和微软Word 2007 canvas的兼容性";
            ...
            this.label10.Text = "选择要写入的文档格式(DOCX/RTF)";
